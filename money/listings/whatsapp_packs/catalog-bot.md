# I will build you a WhatsApp AI catalog & order bot (no paid API)

**Price:** $600/gig
**Margin:** —%
**Tags:** whatsapp bot, ai agent, ecommerce automation, chatwoot, baileys, n8n, whatsapp business, no code automation
...
## Delivery process
- **Basic** ($150, 3 days): Single flow; 1 workflow; Email support
- **Standard** ($600, 5 days): Setup + test; Up to 3 flows; Loom walkthrough; 7-day support
- **Premium** ($1200, 7 days): Full system; Unlimited flows; Monthly retainer option; Priority support
...
```json
{
 ...
 "note": "Tools: Baileys (WhiskeySockets) + Chatwoot + n8n + local LLM \u2014 all free/self-hosted. Replace code node with your agent logic. Baileys repo: https://github.com/WhiskeySockets/Baileys"
}
```
