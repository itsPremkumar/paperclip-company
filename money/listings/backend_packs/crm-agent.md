# I will wire an autonomous CRM/enrichment agent into your stack

**Price:** $1000/gig
**Margin:** —%
**Tags:** crm automation, lead enrichment, ai agent, n8n, crawl4ai, sales automation, workflow, b2b
...
## Delivery process
- **Basic** ($250, 5 days): Single agent; 1 workflow; Email support
- **Standard** ($1000, 10 days): Setup + test; Up to 3 agents; Loom walkthrough; 7-day support
- **Premium** ($2000, 14 days): Full system; Unlimited agents; Monthly retainer option; Priority support
...
```json
{
 ...
 "note": "Tools: n8n + Crawl4AI + maps-cli patterns + Flowise \u2014 all free/self-hosted. Replace code node with your agent logic."
}
```
