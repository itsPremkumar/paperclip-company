# I will build an autonomous market/competitor research agent

**Price:** $900/gig
**Margin:** —%
**Tags:** market research, competitor monitoring, ai agent, crawl4ai, n8n, listmonk, business intelligence, automation
...
## Delivery process
- **Basic** ($225, 5 days): Single agent; 1 workflow; Email support
- **Standard** ($900, 10 days): Setup + test; Up to 3 agents; Loom walkthrough; 7-day support
- **Premium** ($1800, 14 days): Full system; Unlimited agents; Monthly retainer option; Priority support
...
```json
{
 "name": "deliver-be-research-agent",
 "nodes": [
  {
   "parameters": {},
 ...
 "note": "Tools: Crawl4AI + n8n + Listmonk + Flowise \u2014 all free/self-hosted. Replace code node with your agent logic."
}
```
