# I will localize your ad videos into 10 languages with AI dubbing

**Price:** $250/gig
**Margin:** —%
**Tags:** video translation, ai dubbing, multilingual ads, libretranslate, edge tts, whisper, localization, ad creative
...
## Delivery process
- **Basic** ($62, 3 days): 1 video; 1 workflow; Email support
- **Standard** ($250, 5 days): Up to 5 videos; Setup + test; Loom walkthrough; 7-day support
- **Premium** ($500, 7 days): Unlimited videos; Full system; Monthly retainer option; Priority support
...
```json
{
 "name": "deliver-ugc-translation-ads",
 "nodes": [
  {
   "parameters": {},
   "name": "Webhook (intake)",
 ...
 "note": "Tools: Edge-TTS + Whisper + LibreTranslate + Remotion \u2014 all free/self-hosted. Replace code node with your render logic."
}
```
